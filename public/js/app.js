...
jQuery(document).ready(function ($) {
  ...
  var Site = function () {
    ...
    var ajaxCallback = function ajaxCallback(f, u, c, t) {
    ...
    var removeFieldError = function removeFieldError() {
    ...
    var showFieldError = function showFieldError(errors, f) {
      console.log(errors);
      // removeFieldError();
    ...
    var afterModal = function afterModal() {
      preventSubmit();
      initButton();
    };
    var initValidateDefaults = function initValidateDefaults() {
      if (typeof $.validator !== 'undefined') {
    ...
    var jiraCheckbox = function jiraCheckbox() {
      $('#jira_checkbox').prop('checked', false);
      $('#jira_checkbox').change(function () {
        if (this.checked) $('#jira_settings').fadeIn('fast');else $('#jira_settings').fadeOut('fast');
      });
    };
    var initPrivate = function initPrivate() {
    ...
    var initPlatformTypeField = function initPlatformTypeField() {
    ...
    var initOpentab = function initOpentab() {
